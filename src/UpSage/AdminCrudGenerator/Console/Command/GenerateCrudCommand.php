<?php
 ...
 namespace UpSage\AdminCrudGenerator\Console\Command;
 ...
 class GenerateCrudCommand extends Command {
  ...
  protected function configure() {
   $this->setName('upsage:admincrud:generate')
    ->setDescription('Creates a new Magento 2 Admin Crud')
  ...
  protected function execute(InputInterface $input, OutputInterface $output) {
   ...
   $templatesDir = BP . '/app/code/UpSage/AdminCrudGenerator/templates/';
